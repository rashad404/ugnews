    ...
    public static function getFlash()
    {
        ...
        if($session["message"]!=''){
            if($session["type"]=='error'){
                ...
                $es = 'background: #e8ae00;color:#fff;';
            }else{
                $es = 'background: #46b29d;color:#fff;';
            }
            return '<div class="alert alert-dismissablexx alertimxx" style="'.$es.'">
                    <button type="button" class="close alertimbtn" data-dismiss="alert" aria-hidden="true" id="flash_close">×</button>
