...
class Slider extends MyController
{
    ...
    public static $controllerName = 'slider';
    public static $controllerTitle = 'Slayder';

    public static $imageSizeX = 1600;
    public static $imageSizeY = 800;
    public static $thumbSizeX = 800;
    public static $thumbSizeY = 500;
...
//        $ext = end($file_arr);
        ...
        FileUploader::imageResizeProportional($new_thumb_dir.'/'.$file_name, $new_thumb_dir.'/'.$file_name, 60, self::$thumbSizeX, self::$thumbSizeY);
    }
