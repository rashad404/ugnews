...
class Testimonials extends MyController
{

    public static $controllerName = 'testimonials';
    public static $controllerTitle = 'Testimonials';

    public static $imageSizeX = 650;
    public static $imageSizeY = 450;

    public static $thumbSizeX = 430;
    public static $thumbSizeY = 300;
...
//'title_'.self::$def_language => ['required',],
    ...
    public function __construct()
    {
        ...
        self::$rules = ['text_'.self::$def_language.'' => ['required']];
        parent::__construct();
    ...
    {
        $values = ["id"=> '', "title"=> '', "text"=> '', "status"=>'', "page"=>"index"];
...
//        $ext = end($file_arr);
    ...
    protected function getSearchParams(){
        ...
        if(isset($_GET["submit"])){
            ...
            $search_array = " WHERE ";
            $search_execute = [];
            $values = ["id"=> '',"text"=> '', "status"=>'', "page"=>"search"];
