...
use Helpers\Session;
use Modules\admin\Models\GeneralModel;
use Core\View;
use Helpers\Url;
use Modules\admin\Models\model;
...
class Users extends MyController
{
    ...
    public function index()
    {
		...
		View::renderModule($this->dataParams["cName"].'/index',$data);
    }
	...
	public function delete($id)
	{
		...
		Url::previous(MODULE_ADMIN."/".$this->dataParams["cName"]);
	}
