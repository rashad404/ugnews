...
class FaqsModel extends Model{
    ...
    public function __construct($params){
        parent::__construct();
        self::$rules = [
            'question' => ['min_length(3)', 'max_length(250)'],
            'answer' => ['positive', 'min_length(1)', 'max_length(2000)'],
        ];
    ...
    public static function getInputs(){
        $array[] = ['type'=>'text', 'name'=>'Question', 'index'=>true, 'key'=>'question', 'sql_type'=>'varchar(256)'];
        $array[] = ['type'=>'textarea', 'name'=>'Answer', 'index'=>false, 'key'=>'answer', 'sql_type'=>'text'];
...
//        Console::varDump($_POST);
    ...
    public static function getList(){
        return self::$db->select("SELECT ".self::getSqlFields()." FROM ".self::$tableName." ORDER BY `position` ".self::$params['order'].",`id` ASC ");
    }
