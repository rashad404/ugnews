...
class FeaturesModel extends Model{
	...
	public function getDataParams()
	{
		$this->dataParams = [
			"cName" => "features",
			"cModelName" => "FeaturesModel",
			"cTitle" => self::$language->get("Features"),
	...
	public function getPost()
	{
		...
		$array["type"] = Security::safe($_POST['type']);
		if(isset($_POST['select_options'])) {
            $array["select_options"] = Security::safe($_POST['select_options']);
            $array["select_options"] = preg_replace("/, /", ",", $array["select_options"]);
//            echo $array["select_options"];exit;
            $array["select_options"] = json_encode(explode(",", $array["select_options"]));
        }
