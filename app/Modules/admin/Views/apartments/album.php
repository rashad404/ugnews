...
<section class="content">
    ...
    <div class="row pad-top-15">
        <div class="col-xs-12"><!-- /.box -->
            <form action="<?php echo Url::to(MODULE_ADMIN."/".$params["cName"]."/album_operation")?>" method="post">
                <div class="box">
                    <div class="box-body">
                            ...
                            <?php foreach($data["list"]  as $item){ ?>
                                <tr>
                                    ...
                                    <?php if($params["cCrudMode"]){ ?>
                                        <td class="admin-arrow-box">
                                            <a href="/<?=MODULE_ADMIN."/".$params["cName"]?>/delete_album_photo/<?=$item["id"]?>" title="" data-toggle="tooltip" class="btn btn-xs btn-danger delete_confirm" data-original-title="Delete">
