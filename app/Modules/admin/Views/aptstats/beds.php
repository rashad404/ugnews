...
use \Helpers\Session;
use Modules\admin\Models\BedsModel;
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6 total_stats">
                ...
                <div><span class="table_key">
                        <a href="#notice_table"><?=$lng->get('Notice Beds')?></a>:
                    </span> <span class="table_value">- <?=$notice_beds?></span></div><div class="clearBoth"></div>
                <div><span class="table_key"><a href="#vacant_table"><?=$lng->get('Vacant Beds')?></a>:</span><span class="table_value <?=($vacant_beds>0)?'red_color':''?>"> <?=$vacant_beds?></span></div><div class="clearBoth"></div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6 stats_bed_list" id="vacant_table">
                ...
                <table class="notice_table">
                    ...
                    $array = TenantsModel::getBreakPredictList();
