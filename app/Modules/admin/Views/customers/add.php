...
$defaultLanguage = LanguagesModel::getDefaultLanguage('admin');
?>
<!-- Content Header (Page header) -->
<section class="content-header">
    <div class="headtext">
        <span><a href="index"><span style="color:#8bc34a;"><?= $params["title"]; ?></span></a> / <?=$data['lng']->get('Add')?></span>
    </div>
</section>
        ...
        <div class="col-xs-12"><!-- /.box -->
            ...
            <div class="box">
                <div class="box-header">
                    <div class="col-xs-6">
                        <h3 class="box-title"><?=$data['lng']->get('Add')?></h3>
                    </div>
                    <div class="col-xs-6">
