...
$texts = \Modules\admin\Models\old::getTexts();
?>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="dropdown secimet">
                            ...
                            <a href="<?php echo Url::to(MODULE_ADMIN."/seotexts/create")?>" class="btn btncolor secimetbtnadd">
                                Add
                        ...
                        <table id="datatable2" class="table table-striped table-responsive">
                            ...
                            <tr>
                                ...
                                <?php if($params["cStatusMode"]){ ?><th>Aktivlik</th><?php } ?>
                            ...
                            <?php foreach($data["rows"]  as $row){ ?>
                                <tr>
                                    ...
                                    <td class="admin-arrow-box"><?= $row["text"]?></td>
                                    <td class="admin-arrow-box">(<?= $row["id"]?>, '<?= $row["title"]?>')</td>
                                    ...
                                    <?php if($params["cCrudMode"]){ ?>
                                        <td class="admin-arrow-box"> <?= $opButtons->getCrudIconsEdit($row["id"],MODULE_ADMIN."/seotexts")?> </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
                            </tbody>
