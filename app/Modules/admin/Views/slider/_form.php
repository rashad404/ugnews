    ...
    <div class="box-body">
                ...
                <div class="tab-pane fade <?= $k=='0' ? 'active in' : ''?>" id="lang-<?= $language["name"]?>">
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <input class="form-control admininput" type="text" name="title_<?= $language["name"] ?>" value="<?=$model?$model["title_".$language["name"]]:'Slider'?>">
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="form-group">
        ...
        <div class="col-sm-8">
            <div class="form-group">
                ...
                <input class="form-control admininput" type="text" name="link" value="<?=$model?$model["link"]:''?>" placeholder="http://">
            </div>
        </div>
    </div><!-- /.box-body -->
