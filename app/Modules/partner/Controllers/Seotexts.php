...
use Helpers\Session;
use Modules\partner\Models\SeoTextsModel;
use Models\LanguagesModel;
use Core\View;
use Helpers\Url;

class Seotexts extends MyController{
    ...
    public function __construct(){
        ...
        self::$model = new SeoTextsModel(self::$params);
        parent::__construct();
    }
    ...
    public function operation(){
        ...
        return Url::previous(MODULE_PARTNER."/".$this->dataParams["cName"].'/index');
    }
