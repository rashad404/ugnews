...
use Modules\partner\Models\SubscribeModel as TableModel;
use Models\LanguagesModel;
use Core\View;
use Helpers\Url;

class Subscribe extends MyController
{
    ...
    public static $imageFolder = 'subscribe';
    ...
    {
        $values = ["id"=> '', "mail"=> '', "status"=>'', "page"=>"index"];
    ...
    public function search(){
        if($_POST){
            $word = $_POST['word'];
            $rows = $this->searchLikeFor($this->dataParams["cName"],['id','mail'],$word);
        } else {
