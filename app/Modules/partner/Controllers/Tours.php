...
use Modules\partner\Models\ToursModel;
...
class Tours extends MyController
{
    ...
    public static $controllerName = 'tours';
    public static $controllerTitle = 'Turlar';

    public static $imageSizeX = 640;
    public static $imageSizeY = 400;
    public static $thumbSizeX = 246;
    public static $thumbSizeY = 223;
...
//'title_'.self::$def_language => ['required',],
    ...
    public function create()
    {
        ...
        if(isset($_POST["submit"]) && Csrf::isTokenValid() ){
            ...
            $rules = self::$rules;
            $validator = Validator::validate($postArray,$rules,ToursModel::naming());
        ...
        View::renderPartner($this->dataParams["cName"].'/create',[
            ...
            'lng' => self::$lng,
            'feature_list' => ToursModel::getFeatures(),
            'countries' => ToursModel::getCountries(),
            'categories' => ToursModel::getCategories(),
        ]);
    ...
    public function update($id)
    {
        ...
        if(isset($_POST["submit"]) && Csrf::isTokenValid() ){
            ...
            $validator = Validator::validate($postArray,self::$rules, ToursModel::naming());
            if($validator->isSuccess()){
...
//        $ext = end($file_arr);
        ...
        //Optimize images
        FileUploader::imageResizeProportional($new_dir.'/'.$file_name, $new_dir.'/'.$file_name, 60, self::$imageSizeX, self::$imageSizeY);
        FileUploader::imageResize($new_thumb_dir.'/'.$file_name, $new_thumb_dir.'/'.$file_name, 60, self::$thumbSizeX, self::$thumbSizeY);
    }
