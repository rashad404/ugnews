...
class ChannelsModel extends Model
{
    ...
    public static function getInputs()
    {
        return [
            ...
            ['type' => 'select2', 'name' => 'Select Country', 'key' => 'country_id', 'sql_type' => 'varchar(2)', 'data' => self::getCountries()],
            ['type' => 'select2', 'name' => 'Select Language', 'key' => 'language_id', 'sql_type' => 'varchar(2)', 'data' => self::getLanguages()],
