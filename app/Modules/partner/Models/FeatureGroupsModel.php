...
class FeatureGroupsModel extends Model{
	...
	{
		$this->dataParams = [
			"cName" => "feature_groups",
			"cModelName" => "FeatureGroupsModel",
			"cTitle" => self::$language->get("Feature Groups"),
	...
	public function getPost()
	{
		...
		$array["features"] = json_encode($_POST['features']);
	...
	public function getFeatureList()
    {
        ...
        `id`,
        `name` 
         FROM `features` ORDER BY `position`');
        return $rows;
    }
