...
class NoticesModel extends Model{
    ...
    public static function getInputs(){
        $array[] = ['type'=>'select2',         'name'=>'Tenant',       'key'=>'user_id',        'sql_type'=>'int(11)', 'data'=>self::getTenantList()];
        $array[] = ['type'=>'select2',         'name'=>'Notice',        'key'=>'notice_id',         'sql_type'=>'int(11)', 'data'=>self::getNoticeTemplateList()];
        $array[] = ['type'=>'',         'name'=>'',        'key'=>'notice_title',         'sql_type'=>'varchar(200)'];
        $array[] = ['type'=>'',         'name'=>'',        'key'=>'notice_text',         'sql_type'=>'text'];
        $array[] = ['type'=>'textarea',         'name'=>'Note (Not visible to Tenant)',        'key'=>'note',         'sql_type'=>'text'];
        $array[] = ['type'=>'',             'name'=>'',                 'key'=>'viewed',            'sql_type'=>'tinyint(1)'];
