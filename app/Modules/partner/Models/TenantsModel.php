...
class TenantsModel extends Model{
    ...
    public static function getInputs(){
        ...
        $array[] = ['type'=>'text',         'name'=>'Rent',     'key'=>'rent',           'sql_type'=>'decimal(10,2)'];
        $array[] = ['type'=>'text',         'name'=>'Parking',     'key'=>'parking',           'sql_type'=>'decimal(10,2)'];
        ...
        $array[] = ['type'=>'',             'name'=>'',                 'key'=>'address',             'sql_type'=>'varchar(255)'];
        ...
        $array[] = ['type'=>'select2',   'name'=>'Select a bed',     'key'=>'bed_id',            'sql_type'=>'int(5)', 'data' => self::getBedOptions(self::$user_id)];
        $array[] = ['type'=>'select2',      'name'=>'Break Predicts',           'key'=>'break_predict',            'sql_type'=>'int(1)', 'data' => self::getBreakPredicts()];
        $array[] = ['type'=>'textarea',      'name'=>'Note',           'key'=>'note',            'sql_type'=>'varchar(255)'];
        return $array;
    }
