...
<form action="" method="post" enctype="multipart/form-data">
    <div class="form_box">
        <div class="row ">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <div class="slim" style="height:225px!important;" data-label="<?= $lng->get('Choose a photo'); ?>" data-label-loading="" data-button-edit-label="" data-button-remove-label="" data-button-upload-label="" data-button-cancel-label="Cancel" data-button-confirm-label="Ok" data-rotation="90" data-size="9000,9000">
            ...
            <?php $dp_c = 0;
            $dtp_c = 0;
            foreach ($data['input_list'] as $value) : ?>
        ...
        <div class="col-sm-<?= ($value['type'] == 'textarea') ? '12' : '9' ?>">
            <div class="form-group">
                ...
                <?php elseif ($value['key'] == 'link') : ?>
                    <input class="form-control admininput" type="<?= $value['type'] ?>" placeholder="https://" name="<?= $value['key'] ?>" value='<?= $item ? $item[$value['key']] : '' ?>'>
                <?php else : ?>
         ...
         <div class="col-12">
                ...
                <div class="input-group pull-right">
                    <div class="pos-rel-top-6 ">
                        ...
                        <input class="admin-switch" data-on-text="" data-off-text="" id="status" type="checkbox" name="status" value="1" <?php if ($item && $item["status"] == 0) echo "";
                                                                                                                                            else echo "checked"; ?>>
                    </div>
                </div>
            </div>
