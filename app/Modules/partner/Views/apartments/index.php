                            ...
                            <?php foreach($data["rows"]  as $row){ ?>
                                <tr>
                                    ...
                                    <?php if($params["cCrudMode"]){ ?>
                                        <td class="admin-arrow-box">
                                            <a href="/<?=MODULE_PARTNER?>/prices/index/<?=$row["id"]?>" title="" data-toggle="tooltip" class="btn btn-xs btn-primary" data-original-title="Prices">
                                                <i class="fas fa-dollar-sign" style="padding:0 2px;"></i>
                                            </a>
                                            <a href="/<?=MODULE_PARTNER?>/rooms/index/<?=$row["id"]?>" title="" data-toggle="tooltip" class="btn btn-xs btn-primary" data-original-title="Rooms">
                                                <i class="fa fa-bars"></i>
                                            </a>
                                            <a href="/<?=MODULE_PARTNER?>/beds/index/<?=$row["id"]?>" title="" data-toggle="tooltip" class="btn btn-xs btn-primary" data-original-title="Beds">
                                                <i class="fa fa-bed"></i>
                                            </a>
                                            <a href="/<?=MODULE_PARTNER?>/parkings/apartment/<?=$row["id"]?>" title="" data-toggle="tooltip" class="btn btn-xs btn-primary" data-original-title="Parkings">
                                                <i class="fa fa-car"></i>
                                            </a>
                                            <a href="/<?=MODULE_PARTNER."/".$params["cName"]?>/album/<?=$row["id"]?>" title="" data-toggle="tooltip" class="btn btn-xs btn-primary" data-original-title="Photos">
                                                <i class="fa fa-image"></i>
                                            </a>
                                            <?= $opButtons->getCrudIconsEditDel($row["id"],MODULE_PARTNER."/".$params["cName"])?>
                                        </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
