        ...
        <div class="col-xs-12">
            ...
            <div class="input-group pull-right">
                <div class="pos-rel-top-6 ">
                    ...
                    <input class="admin-switch" data-on-text="" data-off-text="" id="status" type="checkbox" name="status" value="<?=$item?$item['id']:''?>" <?php if($item && $item["status"]==0) echo ""; else echo "checked";?>>
                </div>
            </div>
        </div>
    </div>
