                ...
                <div class="box">
                    <div class="box-body">
                        <div class="dropdown secimet">
                            ...
                            <a href="<?php echo Url::to(MODULE_PARTNER."/".$params["name"]."/add/".$data['apt_id'])?>" class="btn btncolor secimetbtnadd">
                                Add
                                    ...
                                    <?php foreach ($data['inputs'] as $input_item):?>
                                        <?php if($input_item['index']):?>
                                            ...
                                            if($input_item['type']=='datetime-local'){
                                                ...
                                                $apt_info = ApartmentsModel::getItem($item[$input_item['key']]);
                                                $input_value = $apt_info['name'].'<br/><span style="color: #a4a4a4;">'.$apt_info['address'].'</span>';
                                            }elseif($input_item['key']=='tenant_id'){
                                                if($item[$input_item['key']]==0){
                                                    $input_value = '<span style="color: #66ac66; font-weight: bold">'.$lng->get('Vacant').'</span>';
                                                }else {
