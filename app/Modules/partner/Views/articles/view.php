...
<section class="content-header">
    <div class="headtext">
        <span><a href="../index"><span style="color:#8bc34a;">Məqalələr</span></a> / Bax</span>
    </div>
</section>
                    ...
                    <div class="col-xs-12 secimet">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <label style="width: 100%;float: left"><strong>Başlıq : <?= $data['result']['adi_'.$defaultLang] ?></strong></label>
                                <label style="width: 100%;float: left"><strong>Mətn : <?= htmlspecialchars_decode($data['result']['text_'.$defaultLang]) ?></strong></label>
                            </div>
                        </div>
                        <div class="col-sm-6">
