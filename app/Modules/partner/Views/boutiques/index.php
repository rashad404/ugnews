...
$texts = \Modules\partner\Models\TextsModel::getTexts();
?>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="dropdown secimet">
                            ...
                            <a href="<?php echo Url::to(MODULE_PARTNER."/".$params["name"]."/create")?>" class="btn btncolor secimetbtnadd">
                                Əlavə et
                            ...
                            <?php foreach($data["list"]  as $row){ ?>
                                <tr>
                                    ...
                                    <?php $opButtons = new OperationButtons();?>
                                        <td class="admin-arrow-box"> <?= $opButtons->getPositionIcons($row["id"],MODULE_PARTNER."/".$params["name"])?></td>
                                        <td class="admin-arrow-box"> <?= $opButtons->getStatusIcons($row["id"],$row["status"]); ?> </td>
                                        <td class="admin-arrow-box"> <?= $opButtons->getCrudIconsEditDel($row["id"],MODULE_PARTNER."/".$params["name"])?> </td>
                                    </tr>
                            <?php } ?>
                            </tbody>
                        </table>
