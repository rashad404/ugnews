                    ...
                    <div class="box-body">
                        <div class="dropdown secimet">
                            <a class="dropdown-toggle pointer secimetbtn" data-toggle="dropdown">
                                <span>Secim edin<i class="fa fa-caret-down"></i></span>
                            </a>
                        ...
                        <table id="datatable2" class="table table-striped table-responsive">
                            ...
                            <?php foreach($data["rows"]  as $row){ ?>
                                <tr>
                                    ...
                                    <td class="admin-arrow-box"><?= $row["adi_".$defaultLang]?></td>
                                    <td class="admin-arrow-box"><?= $row["unvani_".$defaultLang]?></td>
                                    <td class="admin-arrow-box"><?= $row["phone"]?></td>
                                    <td class="admin-arrow-box"><?= $row["working_hours"]?></td>
                                    <?php if($params["cPositionEnable"]){ ?>
                                        <td class="admin-arrow-box"> <?= OperationButtons::getPositionIcons($row["id"],MODULE_PARTNER."/".$params["cName"])?></td>
                                    <?php } ?>
                                    ...
                                    <?php if($params["cCrudMode"]){ ?>
                                        <td class="admin-arrow-box"> <?= OperationButtons::getCrudIcons($row["id"],MODULE_PARTNER."/".$params["cName"])?> </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
                            </tbody>
