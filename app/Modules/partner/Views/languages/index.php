    ...
    <div class="col-lg-12">
        ...
        <form action="<?php echo Url::to(MODULE_PARTNER."/".$params["cName"]."/operation")?>" method="post">
            ...
            <div class="panel-heading">
                ...
                <?php if(\Helpers\Session::get('auth_session_role') == 1){ ?><a href="<?php echo Url::to(MODULE_PARTNER."/".$params["cName"]."/create")?>" class="btn  btn-sm btn-success pull-right margin-right-10"><i class="fa fa-plus"></i> Əlavə et</a><?php } ?>
                ...
                <div class="margin-bottom-10">
                    ...
                    <select onChange="window.location.href=this.value" class="form-control" style="width:auto;">
                        ...
                        foreach($languages as $lang){
                            ...
                            echo '<option value="'.Url::to(MODULE_PARTNER.'/'.$params["cName"].'/setdefaultlanguage/'.$lang["id"]).'" '.$selected.'>'.$lang["fullname"].'</option>';
                        }
                        ?>
                    </select>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <?php foreach($data["rows"]  as $row){ ?>
                            <tr>
                                ...
                                <td><?= $row["id"]?></td>
                                <td>
                                    <img src="<?= Url::templateModulePath('partner')."images/flags/".$row["flag"]?>" width="20" height="20"/>
                                      <?= $row["fullname"]?>
                                </td>
