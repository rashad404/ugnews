                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-striped table-responsive">
                            ...
                            <tr>
                                ...
                                <th class="width-20"><?=$data['lng']->get("Series");?></th>
                                <th class="width-20"><?=$data['lng']->get("Code");?></th>
                                <th class="width-20"><?=$data['lng']->get("Partner");?></th>
                                <th class="width-20"><?=$data['lng']->get("Info");?></th>
                                <th class="width-20"><?=$data['lng']->get("Used time");?></th>
                                <th class="width-20"><?=$data['lng']->get("Activated time");?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($data["rows"]  as $row){ ?>
                                <tr>
                                    ...
                                    <td class="admin-arrow-box width-20"><?= $row["series"]?></td>
                                    <td class="admin-arrow-box width-20"><?= $row["code"]?></td>
                                    <?php if($row["pid"]>0){ ?>
                                        <td class="admin-arrow-box width-20"><?= $row["pid"]?></td>
                                        <td class="admin-arrow-box width-20"><?= $row["info"]?></td>
                                        <td class="admin-arrow-box width-20"><?= date("d-m-Y H:i:s",$row["used_time"])?></td>
                                    <?php }else{?>
                                        <td class="admin-arrow-box width-20">-</td>
                                        <td class="admin-arrow-box width-20">-</td>
                                        <td class="admin-arrow-box width-20">-</td>
                                    <?php }?>
                                    <td class="admin-arrow-box width-20"><?= date("d-m-Y H:i:s",$row["activated_time"])?></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
