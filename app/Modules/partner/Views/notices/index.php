                            ...
                            <?php foreach($data["list"]  as $item){ ?>
                                <tr>
                                    ...
                                    <td class="admin-arrow-box">
                                        <?php $tenant_array = \Modules\partner\Models\TenantsModel::getItem($item["user_id"])?>

                                        <?= $tenant_array["first_name"].' '.$tenant_array["last_name"]?>
                                    </td>
                                    <td class="admin-arrow-box">
                                        <?='#'.$item['notice_id'].' '.$item['notice_title']?>
                                    </td>
