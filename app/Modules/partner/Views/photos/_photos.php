...
<div class="form-group" id="gallery-block">
    <div class="row " style="padding: 30px 10px">
        ...
        <div class="form-group">
            <form action="<?= \Helpers\Url::to(MODULE_PARTNER."/photos/upload")?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
        ...
        <?php
            foreach ($photos as $photo){
                ...
                <div class="col-md-3" style="text-align: center;margin-bottom:20px">
                    ...
                    <?php } ?>
                    <a href="<?= \Helpers\Url::to(MODULE_PARTNER."/photos/imagedelete/".$photo["id"])?>" class="btn btn-sm btn-danger gallery-button-text">Sil</a>
                    <a href="<?= \Helpers\Url::to(MODULE_PARTNER."/photos/status/".$photo["id"])?>" title="<?= $status_title?>"  class="btn btn-sm <?= $status_btn?> gallery-button-text"><?= $status_text?></a>
                    <a href="<?= \Helpers\Url::to(MODULE_PARTNER."/photos/position/".$photo["id"]."/up")?>" class="btn btn-success btn-sm gallery-button-text" title="Sol"><i class="fa fa-arrow-circle-left"></i></a>
                    <a href="<?= \Helpers\Url::to(MODULE_PARTNER."/photos/position/".$photo["id"]."/down")?>" class="btn btn-success btn-sm gallery-button-text" title="Sağ"><i class="fa fa-arrow-circle-right"></i></a>
                </div>
