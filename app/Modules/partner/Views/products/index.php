                        ...
                        <table id="datatable2" class="table table-striped">
                            ...
                            <?php foreach($data["rows"]  as $row){ ?>
                                <tr>
                                    ...
                                    <td class="admin-arrow-box width-20"><?= $row["title_az"]?></td>
                                    <td class="admin-arrow-box">
                                        <a class="fancybox" rel="group" href="<?=$row["thumb"]?>" title="<?=$row["title_".$defaultLang]?>"><img class="image-field" src="<?=$row["thumb"].'?v='.time()?>"/></a>
                                    ...
                                    <?php if($params["cCrudMode"]){ ?>
                                        <td class="admin-arrow-box"> <?= OperationButtons::getCrudIconsEditDel($row["id"],MODULE_PARTNER."/".$params["cName"])?> </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
                            </tbody>
