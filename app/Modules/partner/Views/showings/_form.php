...
<form action="" method="post" enctype="multipart/form-data">
    <div class="form_box">
        <div style="font-size: 16px;font-weight:bold;color:#673194;text-align: center"><?=$lng->get('Create new Guest Card')?></div>
        <div class="row default">
            <?php $dp_c=0;$dtp_c=0; foreach ($data['input_list'] as $value) :?>

            <?php if($value['key']=='guest_id'):?>
                    <div class="col-sm-12">
                        <div style="font-size: 16px;font-weight:bold;color:#673194;text-align: center"><?=$lng->get('Or Select existing')?></div>
                    </div>
                </div>
                <div class="row default">
            <?php endif;?>

            <?php if($value['key']=='date'):?>
                    <div class="col-sm-12">
                        <div style="font-size: 16px;font-weight:bold;color:#673194;text-align: center"><?=$lng->get('Details')?></div>
                    </div>
                </div>
                <div class="row default">
            <?php endif;?>
...
//                            echo $input_value;
                        ...
                        if($value['type']=='datetime'){
                            ...
                            $input_value = date('m/d/Y h:i A',$input_value);
                        }
