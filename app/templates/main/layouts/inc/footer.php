    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8 xl:col-span-1">
                <img class="h-10" src="<?=Url::templatePath()?>/img/partner_logos/<?=$_PARTNER['header_logo_white']?>" alt="<?=PROJECT_NAME?> logo"/>
                <p class="text-gray-400 text-base">
                    <?= $lng->get('FooterAboutText'); ?>
                </p>
...
<nav class="fixed bottom-0 inset-x-0 bg-white shadow flex justify-between text-sm text-gray-700 uppercase font-mono md:hidden">
    <a href="/" class="w-full block py-2 px-3 text-center hover:bg-gray-200">
        <svg class="w-4 h-4 mb-1 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
        <?=$lng->get('Home')?>
    </a>
    <a href="/rating/news" class="w-full block py-2 px-3 text-center hover:bg-gray-200">
        <svg class="w-4 h-4 mb-1 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
        <?=$lng->get('Trending')?>
    </a>
    <button id="mobileSearchToggle" class="w-full block py-2 px-3 text-center hover:bg-gray-200">
        <svg class="w-4 h-4 mb-1 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
        <?=$lng->get('Search')?>
    </button>
    <a href="/create/channel" class="w-full block py-2 px-3 text-center hover:bg-gray-200">
        <svg class="w-4 h-4 mb-1 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
        <?=$lng->get('Create')?>
    </a>
</nav>
