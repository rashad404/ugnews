    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8 xl:col-span-1">
                <img class="h-10" width="107" height="40" src="<?=Url::templatePath()?>/img/partner_logos/<?=$_PARTNER['header_logo_white']?>" alt="<?=PROJECT_NAME?> logo"/>
        ...
        <div class="mt-12 border-t border-gray-700 pt-8">
            <p class="text-base text-gray-400 xl:text-center">
                &copy; <?= date("Y")?> <?=SITE_NAME?> | <?=$lng->get('All rights reserved')?>
...
<nav class="fixed bottom-0 inset-x-0 bg-white shadow flex justify-between text-xs text-gray-700 uppercase font-mono md:hidden">
    ...
    <button id="mobileSearchToggle" class="w-full block py-2 px-3 text-center hover:bg-gray-200">
        ...
        <span class="uppercase"><?=$lng->get('Search')?></span>
    </button>
