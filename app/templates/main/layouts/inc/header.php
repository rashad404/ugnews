        ...
        <div class="flex justify-between items-center py-2 lg:py-6">
            <div class="flex items-center">
                ...
                <div class="hidden lg:ml-6 lg:flex lg:space-x-6">
                    <?php foreach (array_slice($data['menus'], 0, 7) as $menu): ?>
            ...
            <div class="flex items-center">
                <div x-data="{ open: false }" class="ml-3 relative">
                    <div>
                        <button @click="open = !open" type="button" class="flex items-center text-base font-medium text-gray-500 hover:text-gray-900" id="user-menu" aria-expanded="false" aria-haspopup="true">
