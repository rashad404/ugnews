            ...
            <div class="row paddingBottom40">
                ...
                <form action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <select class="same_line_select" name="smoke" required>
                                <option <?=($postData['smoke'] == 0)?'selected':''?> value="0"><?=$lng->get('No')?></option>
                                <option <?=($postData['smoke'] == 1)?'selected':''?> value="1"><?=$lng->get('Yes')?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <select class="same_line_select" name="animals" required>
                                <option <?=($postData['animals'] == 0)?'selected':''?> value="0"><?=$lng->get('No')?></option>
                                <option <?=($postData['animals'] == 1)?'selected':''?> value="1"><?=$lng->get('Yes')?></option>
                            </select>
                        </div>
                    </div>
