    ...
    <section xmlns="http://www.w3.org/1999/html">
        <div class="container-fluid inner_background">
            <h3><?=$item['first_name']?>,
                ...
                <?=Date::dateToAge($item['birthday'])?> <?=$lng->get("years")?>
            </h3>
        </div>
        <div class="container">
                        ...
                        <div class="col-md-12">
                            <div class="custom_block">
                                <div class="blog_image">
                                    <div>
                                        <img id="product_inner_main_img" class="product_inner_main" src="<?=Url::filePath()?>/users/<?=$item['user_id']?>.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="custom_block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6"><?=Features::getSmoke($item['smoke'])?></div>
                                </div>
                                <div class="row">
                            ...
                            <div class="sidebar_amenities_block sidebar custom_block">
                                ...
                                <ul>
                                    <?php $c=1;foreach ($features as $feature):?>
                                        <li><i class="fa fa-check"></i> <?=ApartmentsModel::getFeatureName($feature)?></li>
                                        <?php if($c>=30): ?>
                                            <li><i class="fa fa-check"></i> <?=$lng->get("And more")?>...</li>
                                            <?php break;endif; ?>
                                        <?php $c++;endforeach; ?>
                                </ul>
                            </div>
                        ...
                        <div class="row" style="display: flex;flex-direction: column;">
                            <div class="col-md-12 sidebar_info_block remove_col_padding_web">
                                ...
                                <div class="sidebar_content_apartments">
                                    ...
                                    <div class=""><a href="message/<?=$item['user_id']?>" class="message_button"><?=$lng->get("Send message")?></a> </div>
                                </div>
                            </div>
                            </div>
                        </div>
