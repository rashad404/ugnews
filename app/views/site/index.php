...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <?php if ($data['current_page'] <= 1): ?>
        <div class="mt-8">
            ...
            <div class="mt-4 flex overflow-x-auto pb-2 -mx-4 sm:mx-0">
                ...
                <?php foreach ($data['channel_list'] as $list): ?>
                    <div class="flex-none px-4 sm:px-0 mr-4">
                        <a href="/<?= Format::urlTextChannel($list['name_url']) ?>" class="block w-20 text-center">
                            <img src="<?= Url::filePath() ?>/<?= $list['thumb'] ?>?aas" alt="<?= $list['name'] ?>" class="w-20 h-20 object-cover rounded-full mb-2">
    ...
    <div class="mt-8">
        <div class="flex justify-between items-center">
            ...
            <a href="rating/news" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                <?= $lng->get('TOP') ?> <i class="fas fa-chart-bar"></i>
            </a>
        </div>
