    ...
    <section>
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-10">
                <h1 class="text-5xl font-extrabold text-gray-800"><?= $lng->get($currentWeather['city_name']) ?> <?=$lng->get('Weather App')?></h1>
                <p class="text-lg text-gray-600 mt-2"><?=date("d-m-Y")?> <?= $lng->get($currentWeather['city_name']) ?> <?=$lng->get('Weather Forecast')?></p>
            </div>
            ...
            <div class="mb-10">
                ...
                <div class="bg-gradient-to-r from-blue-200 via-blue-300 to-blue-400 p-6 rounded-lg shadow-lg flex flex-col md:flex-row justify-between items-center relative">
                    <div>
                        <h2 class="text-3xl font-bold text-blue-900 mb-4"><?= $lng->get($currentWeather['city_name']) ?> <?= $lng->get('Current Weather in') ?></h2>
