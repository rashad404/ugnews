...
<main class="main">
    <section xmlns="http://www.w3.org/1999/html">
        <div class="container-fluid inner_background">
            <h3><i class="fa fa-id-card"></i> <?=$lng->get('United Kingdom visa')?> <?=$lng->get('support')?></h3>
        ...
        <div class="container">
            <div class="row paddingTop40 paddingBottom40">
                ...
                <div class="col-md-4">
                    <?php $selected_menu='uk'; include 'menu.php'; ?>
                </div>
                ...
                <div class="col-md-8">
                    <div class="visa_content">
                        ...
                        <div class="content_part">
                            ...
                            <p>Sizin müraciətinizin cavabı təqribən 15 iş günü ərzində cavablandırılır.</p>
                        </div>
                        <div class="content_part">
